 ...
 * This example can be viewed at http//sandbox.eliasranzschleifer.com/twitch-oauth/
 * 
 */

class TwitchTv {
    // Note this is setup to be looking at my Test oAuth application in Twitch, you'll want to use the main class and swap out the values for your own.
    var $base_url = "https://api.twitch.tv/kraken/";
    var $client_id = 'n72h95320wbqs3rc85xkgrkz2ir76fr'; //change this value, should be your TwitchTV Application Client ID
    var $client_secret = "q2c93ssc6tdvjrv4osrpbhwe185d8xq"; //change this value, should be your TwitchTV Application Client Secret
    var $redirect_url = 'http://sandbox.eliasranzschleifer.com/twitch-oauth/examples/'; //change this value, should be your TwitchTV Application Rerdirect URL
